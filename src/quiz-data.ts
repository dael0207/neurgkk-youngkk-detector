...
export const quizQuestions = [
  {
    ...
    choices: [
      { id: "q1-c1", label: "토핑 뭐 올릴지부터 고른다", points: 4 },
      { id: "q1-c2", label: "아이돌 정리 계정 링크를 보낸다", points: 0 },
      { id: "q1-c3", label: "정모 장소부터 물어본다", points: 1 },
  ...
  },
  {
    ...
    choices: [
      { id: "q2-c1", label: "중꺾마 아직 살아있다", points: 4 },
      { id: "q2-c2", label: "중간에 꺾으면 마이너스지", points: 1 },
      { id: "q2-c3", label: "중요한 건 마감부터", points: 2 },
      { id: "q2-c4", label: "중독은 꺾어야지", points: 0 },
    ],
  },
  {
    id: "q3",
  ...
  },
  {
    ...
    choices: [
      { id: "q4-c1", label: "맥락 보고 센스 있게 처리", points: 4 },
      { id: "q4-c2", label: "알림부터 깔끔하게 끄기", points: 2 },
  ...
  },
  {
    ...
    choices: [
      { id: "q5-c1", label: "이건 완전 스불재다", points: 4 },
      { id: "q5-c2", label: "스토리 불펌 재업 각이다", points: 1 },
      { id: "q5-c3", label: "스마트폰부터 재부팅하자", points: 0 },
  ...
  },
  {
    ...
    choices: [
      { id: "q6-c1", label: "그 장면 진짜 레전드", points: 4 },
      { id: "q6-c2", label: "로제 떡볶이가 생각남", points: 1 },
      { id: "q6-c3", label: "리즈 시절 도전 중", points: 2 },
      { id: "q6-c4", label: "라지 사이즈 디자인", points: 0 },
    ],
  },
  {
    id: "q7",
  ...
  },
  {
    ...
    choices: [
      { id: "q8-c1", label: "나만 이해 못 함?", points: 4 },
      { id: "q8-c2", label: "대략난감이네요", points: 1 },
  ...
  },
  {
    ...
    choices: [
      { id: "q9-c1", label: "옛날 커뮤니티의 짧은 컷", points: 4 },
      { id: "q9-c2", label: "요즘 릴스식 리액션", points: 0 },
      { id: "q9-c3", label: "선물 보낼 때 쓰는 말", points: 1 },
  ...
  },
  {
    ...
    choices: [
      { id: "q10-c1", label: "킹받네", points: 4 },
      { id: "q10-c2", label: "왕 받으셨다", points: 0 },
      { id: "q10-c3", label: "킹 사이즈로 받자", points: 0 },
      { id: "q10-c4", label: "감동받아서 킹정", points: 2 },
    ],
  },
  {
    id: "q11",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "q12-c2", label: "아 그 맥락이면 웃기네", points: 2 },
      { id: "q12-c3", label: "릴스에서 본 듯", points: 3 },
      { id: "q12-c4", label: "ㅇㅈㅋㅋ", points: 4 },
    ],
  },
